...
##################################################################
# November 29,2016                                               #
#  Parse the DDP data to obtain the following information:       #
#   hostname, ip, model, vendor, device_type.                    #
#  device_type will be router, switch, unknown, etc.             #
#  From the data create a dictionary of all the network          #
#  devices. The network_devices dictionary should have the below #
#  format:                                                       #
#   network_devices = {                                          #
#     'SW1': { 'ip': '10.1.1.22',                                #
#                'model': 'WS-C2950-24',                         #
...
#                'device_type': 'router' },                      #
#     ...                                                        #
#  Note that this dicitonary is a dictionary of dictionaries.    #
#  They can be accesses in the same manner as lists,             #
#  'list[a][b]'                                                  #
#                                                                #
##################################################################
...
for i in network_devices:
  print('{}: {}'.format(i, network_devices.get(i)))
